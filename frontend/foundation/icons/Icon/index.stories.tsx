...
export const Icon_: React.FC = () => (
  <DocumentationStory>
    <VariantsGallery columns={4}>
      ...
      <Icon color="neutral.weak" icon="component-1" size="xs" />
      <Icon color="neutral.weak" icon="component-1" size="sm" />
      <Icon color="neutral.weak" icon="component-1" size="md" />

      <Variant label="color" value="neutral.default" />
      <Icon color="neutral.default" icon="component-1" size="xs" />
      <Icon color="neutral.default" icon="component-1" size="sm" />
      <Icon color="neutral.default" icon="component-1" size="md" />

      <Variant label="color" value="neutral.strong" />
      <Icon color="neutral.strong" icon="component-1" size="xs" />
      <Icon color="neutral.strong" icon="component-1" size="sm" />
      <Icon color="neutral.strong" icon="component-1" size="md" />

      <Variant label="color" value="brand.default" />
      <Icon color="brand.default" icon="component-1" size="xs" />
      <Icon color="brand.default" icon="component-1" size="sm" />
      <Icon color="brand.default" icon="component-1" size="md" />
    </VariantsGallery>
